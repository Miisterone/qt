...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FileIndexer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FileIndexer_t qt_meta_stringdata_FileIndexer = {
    {
        QT_MOC_LITERAL(0, 11),  // "FileIndexer"
        QT_MOC_LITERAL(12, 16),  // "indexingProgress"
        QT_MOC_LITERAL(29, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_FileIndexer[] = {
...
Q_CONSTINIT const QMetaObject FileIndexer::staticMetaObject = { {
    ...
    qt_meta_stringdata_FileIndexer.offsetsAndSizes,
    qt_meta_data_FileIndexer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_FileIndexer_t,
        // Q_OBJECT / Q_GADGET
...
void FileIndexer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileIndexer::*)(int );
            if (_t _q_method = &FileIndexer::indexingProgress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
